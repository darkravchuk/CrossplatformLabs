        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MdmCustomerId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PatAddressId = table.Column<int>(type: "INTEGER", nullable: false),
                    MdmDateOfBirth = table.Column<DateTime>(type: "TEXT", nullable: false),
                    OtherDetails = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MdmCustomerId = table.Column<int>(type: "INTEGER", nullable: false),
                    ServiceId = table.Column<int>(type: "INTEGER", nullable: false),
                    DateServiceRequested = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateServiceReceived = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CostOfService = table.Column<decimal>(type: "TEXT", nullable: false),
                    OtherDetails = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
